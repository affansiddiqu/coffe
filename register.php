...
if(isset($_POST['register'])){
  ...
  $email_check = "select * from coffe_table where email = '$user_email'";
  $result = mysqli_query($connection, $email_check);
  if(mysqli_num_rows($result) > 0){
    echo "<script> alert('Email already exist')</script>";
  }else{
    $insert_data = "INSERT INTO `coffe_table` (`username`, `email`, `password`) VALUES ('$user_name', '$user_email', '$pass')";
